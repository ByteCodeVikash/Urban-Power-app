...
import DateSelectionScreen from '../screens/Services/DateSelectionScreen';
import TimeslotSelectionScreen from '../screens/Services/TimeslotSelectionScreen';

// Scrap Foundation Screens
import ScrapCategoriesScreen from '../screens/Kabadi/ScrapCategoriesScreen';
import ScrapItemListScreen from '../screens/Kabadi/ScrapItemListScreen';
import ScrapItemDetailsScreen from '../screens/Kabadi/ScrapItemDetailsScreen';
...
import MaintenanceServicesScreen from '../screens/Maintenance/MaintenanceServicesScreen';
import MaintenanceServiceDetailsScreen from '../screens/Maintenance/MaintenanceServiceDetailsScreen';
      ...
      >
        {!isAuthenticated ? (
          ...
          <>
            ...
            <Stack.Screen
              name="KabadiCategory"
              component={KabadiCategoryScreen}
            />
            <Stack.Screen
              name="KabadiSubCategory"
              component={KabadiSubCategoryScreen}
            />
            <Stack.Screen name="KabadiForm" component={KabadiFormScreen} />
            <Stack.Screen
              name="KabadiBooking"
              component={KabadiBookingScreen}
            />
            <Stack.Screen name="KabadiStatus" component={KabadiStatusScreen} />
            <Stack.Screen
              name="KabadiHistory"
              component={KabadiHistoryScreen}
            />

            {/* Scrap Stack */}
            <Stack.Screen
              name="ScrapCategories"
              component={ScrapCategoriesScreen}
            />
            <Stack.Screen
              name="ScrapItemList"
              component={ScrapItemListScreen}
            />
            <Stack.Screen
              name="ScrapItemDetails"
              component={ScrapItemDetailsScreen}
            />

            {/* Beautician Stack */}
            <Stack.Screen
              name="BeauticianCategories"
              component={BeauticianCategoriesScreen}
            />
            <Stack.Screen
              name="BeauticianServices"
              component={BeauticianServicesScreen}
            />
            <Stack.Screen
            ...
            <Stack.Screen
              ...
              component={MaintenanceCategoriesScreen}
            />
            <Stack.Screen
            ...
            <Stack.Screen
              ...
              component={MaintenanceServiceDetailsScreen}
            />
            <Stack.Screen
            ...
            <Stack.Screen
              ...
              component={TechnicianEarningsScreen}
            />
            <Stack.Screen
            ...
            <Stack.Screen
              name="PaymentUPICredits"
              component={GenericInfoScreen}
            />
            <Stack.Screen
              name="UPIPlusMembership"
              component={GenericInfoScreen}
            />
