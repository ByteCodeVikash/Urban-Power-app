...
export default function ProfileScreen() {
  ...
  const accountMenu = [
    {
      icon: <Calendar size={22} color={Colors.light.text} />,
      label: 'My Bookings',
    ...
    },
    {
      ...
      label: 'Kabadi History',
      onPress: () => navigation.navigate('KabadiHistory'),
    },
    {
      icon: <MapPin size={22} color={Colors.light.text} />,
  ...
  const rewardsMenu = [
    {
      icon: <Gift size={22} color={Colors.light.text} />,
      label: 'Rewards & Offers',
      onPress: () => navigation.navigate('Rewards'),
    },
    {
      icon: <Wallet size={22} color={Colors.light.text} />,
      label: 'UC Wallet',
      value: '₹450',
    },
  ];
  ...
  const professionalMenu = [
    {
      icon: <Briefcase size={22} color={Colors.light.primary} />,
      label: 'Partner Dashboard',
      onPress: () => navigation.navigate('TechnicianHub'),
    },
    {
      icon: <CreditCard size={22} color="#475569" />,
  ...
  const supportMenu = [
    {
      icon: <LifeBuoy size={22} color={Colors.light.text} />,
      label: 'Help & Support',
      onPress: () => navigation.navigate('HelpSupport'),
    },
    {
      icon: <Shield size={22} color={Colors.light.text} />,
    ...
    <View style={styles.menuSection}>
      ...
      {items.map((item, index) => (
        <Pressable key={index} style={styles.menuItem} onPress={item.onPress}>
          ...
          <Typography variant="body1" weight="700" style={styles.menuLabel}>
            {item.label}
          </Typography>
          {item.value && (
            <Typography
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        {!isTab && (
          <View style={styles.header}>
            <Typography variant="h2" weight="900">
              My Profile
            </Typography>
          </View>
        )}
