    ...
    <View style={styles.userCard}>
      ...
      <View style={{ flex: 1, marginLeft: Spacing.md }}>
        ...
        <View style={styles.badgeRow}>
          ...
          {item.role === 'Partner' && (
            <Typography variant="tiny" weight="700" style={{ marginLeft: 8 }}>
              ⭐ {item.rating}
            </Typography>
          )}
        </View>
      ...
      <View style={styles.actions}>
        {item.status === 'Blocked' ? (
          <Pressable style={styles.iconAction}>
            <UserCheck size={18} color={Colors.light.success} />
          </Pressable>
        ) : (
          <Pressable style={styles.iconAction}>
            <UserMinus size={18} color={Colors.light.danger} />
          </Pressable>
        )}
