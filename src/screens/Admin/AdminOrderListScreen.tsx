...
const MOCK_ORDERS = [
  {
    id: '101',
    type: 'Service',
    item: 'Electrician (Switch Repair)',
    customer: 'Amit K.',
    amount: '450',
    status: 'In-Progress',
    time: '2m ago',
  },
  {
    id: '102',
    type: 'Shop',
    item: 'Professional Cleaning Kit',
    customer: 'Priya S.',
    amount: '1200',
    status: 'Shipped',
    time: '15m ago',
      ...
      <View style={styles.orderHeader}>
        ...
        >
          {item.type === 'Service' ? (
            ...
            <ShoppingBag size={14} color="#9D174D" />
          ) : (
