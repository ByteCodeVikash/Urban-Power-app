    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <Pressable style={styles.overviewCard}>
          <View style={{ flex: 1 }}>
            ...
            <Typography variant="h1" color={Colors.light.white} weight="900">
              ₹4,25,000
            </Typography>
          </View>
        ...
        <View style={styles.statsGrid}>
          ...
          >
            ...
            <Typography variant="h2" weight="900" style={{ marginTop: 8 }}>
              156
            </Typography>
            <Typography variant="tiny" color="#7C3AED" weight="700">
              NEW ORDERS
            </Typography>
          </Pressable>
          <Pressable
          ...
          >
            ...
            <Typography variant="tiny" color="#059669" weight="700">
              PROVIDERS
            </Typography>
          </Pressable>
        </View>
        ...
        <View style={styles.healthRow}>
          ...
          <View style={styles.healthItem}>
            <View
              style={[styles.dot, { backgroundColor: Colors.light.warning }]}
            />
            <Typography variant="tiny" weight="700">
              SMS: LAG
            </Typography>
      ...
      <View style={styles.tabSim}>
        <Pressable style={styles.tabActive}>
          <Typography variant="tiny" weight="800" color={Colors.light.primary}>
            DASHBOARD
          </Typography>
        </Pressable>
