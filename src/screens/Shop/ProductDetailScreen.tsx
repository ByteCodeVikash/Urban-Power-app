    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          <Pressable style={styles.iconBtn}>
            <Heart color={Colors.light.text} size={20} />
          </Pressable>
        </View>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.content}>
          ...
          >
            {product.description ||
              'This high-quality product is designed to meet your home care needs with professional efficiency. Part of our curated Urban Shop collection.'}
          </Typography>
