                ...
                <View style={styles.stepRail}>
                  {index !== 0 && (
                    <View
                      style={[
                        styles.line,
                        step.status !== 'pending' && styles.lineActive,
                      ]}
                    />
                  )}
                  <View
        ...
        <View style={styles.section}>
          ...
          <View style={styles.itemRow}>
            ...
            <View style={{ flex: 1, marginLeft: Spacing.md }}>
              ...
              <Typography variant="body2" color={Colors.light.textSecondary}>
                Qty: 1 • Seller: UrbanPower Retail
              </Typography>
            </View>
            <Typography variant="body1" weight="900">
              ₹1,299
            </Typography>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.addressBox}>
            ...
            <Typography variant="body2" style={{ marginLeft: 12, flex: 1 }}>
              ...
              {'\n'}Flat 402, Green Valley Apartments, HSR Layout, Sector 2,
              Bangalore, 560102
            </Typography>
          </View>
        </View>
