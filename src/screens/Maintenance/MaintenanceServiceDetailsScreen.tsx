...
import { useMaintenanceServices } from '../../hooks/useMaintenance';
import { useMaintenanceStore } from '../../store/useMaintenanceStore';
import { RootStackParamList } from '../../navigation/Types';

type MaintenanceServiceDetailsRouteProp = RouteProp<
  RootStackParamList,
...
export default function MaintenanceServiceDetailsScreen() {
  const navigation = useNavigation<NavigationProp>();
  const route = useRoute<MaintenanceServiceDetailsRouteProp>();
  ...
  const {
    ...
    isLoading,
    error,
  } = useMaintenanceServices(undefined);
  const service = services?.find((s: any) => s.id === serviceId);

  const selectedServices = useMaintenanceStore(state => state.selectedServices);
  const addService = useMaintenanceStore(state => state.addService);
  const removeService = useMaintenanceStore(state => state.removeService);
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.infoSection}>
          ...
          >
            {service.description ||
              'No description available for this maintenance service.'}
          </Typography>
          ...
          <View style={styles.instructionsContainer}>
            <View style={styles.instructionRow}>
              ...
              >
                Our background-verified professionals bring all required tools
                for the job.
              </Typography>
            </View>
            <View style={styles.instructionRow}>
              ...
              <Typography
                ...
                style={styles.instructionText}
              >
                Please ensure a clean workspace and provide access to
                water/electricity if required.
              </Typography>
            </View>
          </View>
        </View>
