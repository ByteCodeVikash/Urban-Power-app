...
export const CouponManager: React.FC = () => {
  return (
    <Box>
      ...
      >
        <strong>Pending Backend API</strong> — No coupon/promo-code endpoint
        exists in the backend. A dedicated <code>GET /api/v1/coupons</code> API
        (and corresponding create / update / delete endpoints) is required to
        populate this module. Once available, integrate them here to manage
      ...
      >
        <CardContent sx={{ textAlign: 'center', py: 8 }}>
          ...
          >
            This section will display real coupon records once the backend
            provides a coupon management API. No mock data is shown.
          </Typography>
        </CardContent>
      </Card>
    </Box>
