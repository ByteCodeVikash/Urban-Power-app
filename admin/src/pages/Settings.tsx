...
export const Settings: React.FC = () => {
  ...
  const handleSaveConfigs = (sectionName: string) => {
    setAlertText(`${sectionName} configurations updated and synchronized successfully.`);
    ...
    <Box sx={{ flexGrow: 1 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Configure security roles, business parameters, third-party API gateways, and main operational flags.
        </Typography>
      </Box>
      ...
      <Paper elevation={0} sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
        <Tabs value={activeTab} onChange={handleTabChange} indicatorColor="primary" textColor="primary" variant="scrollable" scrollButtons="auto">
          ...
          <Tab icon={<ThresholdsIcon />} iconPosition="start" label="Business Rules & Thresholds" />
          <Tab icon={<CredentialsIcon />} iconPosition="start" label="API Gateways & Credentials" />
          <Tab icon={<ConfigIcon />} iconPosition="start" label="System Flags & Controls" />
        </Tabs>
      </Paper>
            ...
            <Card>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <Button variant="contained" color="primary" onClick={() => handleSaveConfigs('Access Roles Matrix')}>
                    Save Role Matrix
                  </Button>
                </Box>
              </CardContent>
          ...
          <Grid size={12}>
            <Card>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <Button variant="contained" color="primary" onClick={() => handleSaveConfigs('Business Rules')}>
          ...
          <Grid size={12}>
            <Card>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                  <Button variant="contained" color="primary" onClick={() => handleSaveConfigs('API Gateways')}>
                    Update Credentials
                  </Button>
                </Box>
              </CardContent>
      ...
      {activeTab === 3 && (
        <Grid container spacing={3}>
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  ...
                  <Typography variant="caption" color="text.secondary" sx={{ mt: -2, ml: 4, display: 'block' }}>
                    If turned on, all admins must verify with Google Authenticator token codes during session login.
                  </Typography>
                  ...
                  />
                  <Typography variant="caption" color="text.secondary" sx={{ mt: -2, ml: 4, display: 'block' }}>
                    Dispatches a transactional GST-invoice mail as soon as the technician marks a ticket as complete.
                  </Typography>
                </Box>
              </CardContent>
            </Card>
            ...
            <Card sx={{ height: '100%' }}>
              <CardContent sx={{ p: 3 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  ...
                  />
                  <Typography variant="caption" color="text.secondary" sx={{ mt: -2, ml: 4, display: 'block' }}>
                    Warning: Activating this locks the Android & iOS customer apps, showing a "Back Soon" screen and blocking checkout api endpoints.
                  </Typography>
                </Box>
              </CardContent>
            </Card>
          ...
          <Grid size={12}>
            <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              <Button variant="contained" color="primary" onClick={() => handleSaveConfigs('System Flags')}>
