...
class MaintenanceServiceResponse(BaseModel):
    id: UUID = Field(..., description="Unique identifier of the maintenance service")
...
class MaintenanceCategoryResponse(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    services: List[MaintenanceServiceResponse] = Field(default=[], description="List of services belonging to this category")
